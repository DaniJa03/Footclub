    ...
    <body class="flex items-center justify-center py-8 px-2">
      <div class="w-full sm:px-6">
        <div class="bg-white shadow px-4 md:px-10 pt-4 md:pt-7 pb-5 overflow-y-auto">
          <!-- <div v-for="(a, index) in spielerArray" :key="index">
            <p>{{ a.spielerpassid }}</p>
            <p>{{ a.vorname }}</p>
            <p>{{ a }}</p>
            <p>{{ a }}</p>
          ...
          <table class="w-full whitespace-nowrap">
            <thead>
              ...
              >
                <th class="font-normal text-left pl-4">Mitarbeiterid</th>
                <th class="font-normal text-left pl-12">Nachname</th>
                <th class="font-normal text-left pl-12">Abteilung</th>
              </tr>
            </thead>
            <tbody class="w-full">
              <tr
              ...
              >
                ...
                <td class="pl-20">
                  <p class="font-medium">{{ sub.abteilung }}</p>
                </td>
                <td class="px-7 2xl:px-0">
                  <button
                    @click="emit('deleteMitarbeiter', sub)"
                    type="button"
...
const emit = defineEmits(['copy', 'deleteMitarbeiter']);
</script>
