              ...
              >
                <td class="pl-4 cursor-pointer">
                  <div class="flex items-center">
                    <p class="font-medium">{{a.spielerpassid}}</p>
                  </div>
                </td>
                <td class="pl-12">
                  <p class="text-sm font-medium leading-none text-gray-800">{{a.vorname}}</p>
                </td>
                <td class="pl-12">
                  <p class="font-medium">{{a.nachname}}</p>
                </td>
                <td class="pl-20">
                  <p class="font-medium">{{a.trikotnummer}}</p>
                </td>
